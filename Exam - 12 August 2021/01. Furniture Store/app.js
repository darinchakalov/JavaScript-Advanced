function solve() {
    ...
    addBtn.addEventListener("click", (event) => {
        ...
        document.querySelector("#furniture-list > tr.info > td:nth-child(3) > button.moreBtn")
        document.querySelector("#furniture-list > tr:nth-child(3) > td:nth-child(3) > button.moreBtn")
